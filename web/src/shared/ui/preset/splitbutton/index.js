  ...
  button: {
    root: ({ parent }) => ({
      class: [
        ...
        {
          "text-white dark:text-surface-900":
            parent.props.severity === "contrast" && !parent.props.text && !parent.props.outlined && !parent.props.plain,
        ...
        // Text & Outlined Button
        {
          "hover:bg-surface-900/10 dark:hover:bg-[rgba(255,255,255,0.03)]":
            (parent.props.text || parent.props.outlined) && parent.props.severity === "contrast" && !parent.props.plain,
        },
